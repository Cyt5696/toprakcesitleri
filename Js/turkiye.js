function imgchange(imgid) {
  ...
  switch (imgid) { //Belirlenen text alınan id ye göre değişir
    ...
    case "8":
      text =
        "VERTİSOLLER <br><br>Yumuşak kireç taşı ve killi kireç taşı üzerinde oluşan kalsimorfik topraklara ülkemizin birçok yerinde rastlanır. Anadolu'da kepir veya taş doğuran olarak da bilinen vertisoller; Trakya, Güney Marmara ve Muş Ovası'nda görülür (Görsel 1.132).";
      break;
    case "9":
      text =
